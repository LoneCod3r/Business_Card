...
A small static site styled as a flippable physical business card:
...
| `styles.css` | All styling, including the background artwork and portrait, embedded as data URIs |
| `script.js` | QR code generation and the flip interaction |
